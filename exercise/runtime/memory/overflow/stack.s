"".val.String STEXT size=128 args=0x10 locals=0x18
// 栈大小为24，无参数
	0x0000 00000 (main.go:14)	TEXT	"".val.String(SB), $24-16
	// 通过thread local storage获取当前g(g为goroutine的的数据结构)
	0x0000 00000 (main.go:14)	MOVQ	(TLS), CX
	// 比较SP和g.stackguard0
	0x0009 00009 (main.go:14)	CMPQ	SP, 16(CX)
	// 小于g.stackguard0，jump到121执行栈的扩容
	0x000d 00013 (main.go:14)	JLS	121
	// 继续执行
	0x000f 00015 (main.go:14)	SUBQ	$24, SP
	0x0013 00019 (main.go:14)	MOVQ	BP, 16(SP)
	0x0018 00024 (main.go:14)	LEAQ	16(SP), BP
	// 用于垃圾回收
	0x001d 00029 (main.go:14)	FUNCDATA	$0, gclocals·f207267fbf96a0178e8758c6e3e0ce28(SB)
	0x001d 00029 (main.go:14)	FUNCDATA	$1, gclocals·33cdeccccebe80329f1fdbee7f5874cb(SB)
	0x001d 00029 (main.go:14)	XORPS	X0, X0
	0x0020 00032 (main.go:14)	MOVUPS	X0, "".~r0+32(SP)
	// 将i放入AX寄存器
	0x0025 00037 (main.go:16)	MOVQ	"".i(SB), AX
	0x002c 00044 (main.go:16)	MOVQ	AX, ""..autotmp_2+8(SP)
	0x0031 00049 (main.go:16)	INCQ	AX
	0x0034 00052 (main.go:16)	MOVQ	AX, "".i(SB)
	0x003b 00059 (main.go:17)	PCDATA	$0, $0
	0x003b 00059 (main.go:17)	CALL	runtime.printlock(SB)
	0x0040 00064 (main.go:17)	MOVQ	"".i(SB), AX
	// i压栈
	0x0047 00071 (main.go:17)	MOVQ	AX, (SP)
	0x004b 00075 (main.go:17)	PCDATA	$0, $0
	// 调用runtime.printint
	0x004b 00075 (main.go:17)	CALL	runtime.printint(SB)
	0x0050 00080 (main.go:17)	PCDATA	$0, $0
	0x0050 00080 (main.go:17)	CALL	runtime.printnl(SB)
	0x0055 00085 (main.go:17)	PCDATA	$0, $0
	0x0055 00085 (main.go:17)	CALL	runtime.printunlock(SB)
	0x005a 00090 (main.go:18)	LEAQ	go.string."aaa"(SB), AX
	0x0061 00097 (main.go:18)	MOVQ	AX, "".~r0+32(SP)
	0x0066 00102 (main.go:18)	MOVQ	$3, "".~r0+40(SP)
	0x006f 00111 (main.go:18)	MOVQ	16(SP), BP
	0x0074 00116 (main.go:18)	ADDQ	$24, SP
	0x0078 00120 (main.go:18)	RET
	0x0079 00121 (main.go:18)	NOP
	0x0079 00121 (main.go:14)	PCDATA	$0, $-1
	0x0079 00121 (main.go:14)	CALL	runtime.morestack_noctxt(SB)
	0x007e 00126 (main.go:14)	JMP	0
	0x0000 65 48 8b 0c 25 00 00 00 00 48 3b 61 10 76 6a 48  eH..%....H;a.vjH
	0x0010 83 ec 18 48 89 6c 24 10 48 8d 6c 24 10 0f 57 c0  ...H.l$.H.l$..W.
	0x0020 0f 11 44 24 20 48 8b 05 00 00 00 00 48 89 44 24  ..D$ H......H.D$
	0x0030 08 48 ff c0 48 89 05 00 00 00 00 e8 00 00 00 00  .H..H...........
	0x0040 48 8b 05 00 00 00 00 48 89 04 24 e8 00 00 00 00  H......H..$.....
	0x0050 e8 00 00 00 00 e8 00 00 00 00 48 8d 05 00 00 00  ..........H.....
	0x0060 00 48 89 44 24 20 48 c7 44 24 28 03 00 00 00 48  .H.D$ H.D$(....H
	0x0070 8b 6c 24 10 48 83 c4 18 c3 e8 00 00 00 00 eb 80  .l$.H...........
	rel 5+4 t=16 TLS+0
	rel 40+4 t=15 "".i+0
	rel 55+4 t=15 "".i+0
	rel 60+4 t=8 runtime.printlock+0
	rel 67+4 t=15 "".i+0
	rel 76+4 t=8 runtime.printint+0
	rel 81+4 t=8 runtime.printnl+0
	rel 86+4 t=8 runtime.printunlock+0
	rel 93+4 t=15 go.string."aaa"+0
	rel 122+4 t=8 runtime.morestack_noctxt+0
"".main STEXT size=584 args=0x0 locals=0xe0
    // 栈大小为224，无参数
	0x0000 00000 (main.go:21)	TEXT	"".main(SB), $224-0
	0x0000 00000 (main.go:21)	MOVQ	(TLS), CX
	0x0009 00009 (main.go:21)	LEAQ	-96(SP), AX
	0x000e 00014 (main.go:21)	CMPQ	AX, 16(CX)
	0x0012 00018 (main.go:21)	JLS	574
	0x0018 00024 (main.go:21)	SUBQ	$224, SP
	0x001f 00031 (main.go:21)	MOVQ	BP, 216(SP)
	0x0027 00039 (main.go:21)	LEAQ	216(SP), BP
	0x002f 00047 (main.go:21)	FUNCDATA	$0, gclocals·f6bd6b3389b872033d462029172c8612(SB)
	0x002f 00047 (main.go:21)	FUNCDATA	$1, gclocals·3e9d367ad8e894cbbe1024f46b88885d(SB)
	0x002f 00047 (main.go:24)	PCDATA	$0, $0
	0x002f 00047 (main.go:24)	CALL	"".val.String(SB)
	0x0034 00052 (main.go:24)	MOVQ	(SP), AX
	0x0038 00056 (main.go:24)	MOVQ	8(SP), CX
	0x003d 00061 (main.go:24)	MOVQ	AX, ""..autotmp_3+160(SP)
	0x0045 00069 (main.go:24)	MOVQ	CX, ""..autotmp_3+168(SP)
	0x004d 00077 (main.go:24)	PCDATA	$0, $1
	0x004d 00077 (main.go:24)	CALL	runtime.printlock(SB)
	0x0052 00082 (main.go:24)	MOVQ	""..autotmp_3+168(SP), AX
	0x005a 00090 (main.go:24)	MOVQ	""..autotmp_3+160(SP), CX
	0x0062 00098 (main.go:24)	MOVQ	CX, (SP)
	0x0066 00102 (main.go:24)	MOVQ	AX, 8(SP)
	0x006b 00107 (main.go:24)	PCDATA	$0, $0
	0x006b 00107 (main.go:24)	CALL	runtime.printstring(SB)
	0x0070 00112 (main.go:24)	PCDATA	$0, $0
	0x0070 00112 (main.go:24)	CALL	runtime.printnl(SB)
	0x0075 00117 (main.go:24)	PCDATA	$0, $0
	0x0075 00117 (main.go:24)	CALL	runtime.printunlock(SB)
	0x007a 00122 (main.go:25)	LEAQ	go.itab."".val,"".Stringer(SB), AX
	0x0081 00129 (main.go:25)	MOVQ	AX, "".value+80(SP)
	0x0086 00134 (main.go:25)	LEAQ	runtime.zerobase(SB), AX
	0x008d 00141 (main.go:25)	MOVQ	AX, "".value+88(SP)
	0x0092 00146 (main.go:26)	MOVQ	"".value+88(SP), AX
	0x0097 00151 (main.go:26)	MOVQ	"".value+80(SP), CX
	0x009c 00156 (main.go:26)	MOVQ	CX, ""..autotmp_7+112(SP)
	0x00a1 00161 (main.go:26)	MOVQ	AX, ""..autotmp_7+120(SP)
	0x00a6 00166 (main.go:26)	TESTQ	CX, CX
	0x00a9 00169 (main.go:26)	JNE	176
	0x00ab 00171 (main.go:26)	JMP	572
	0x00b0 00176 (main.go:26)	TESTB	AL, (CX)
	0x00b2 00178 (main.go:26)	MOVL	16(CX), AX
	0x00b5 00181 (main.go:26)	MOVL	AX, ""..autotmp_9+68(SP)
	0x00b9 00185 (main.go:26)	XORPS	X0, X0
	0x00bc 00188 (main.go:26)	MOVUPS	X0, "".str+96(SP)
	0x00c1 00193 (main.go:26)	MOVQ	""..autotmp_7+120(SP), AX
	0x00c6 00198 (main.go:26)	MOVQ	""..autotmp_7+112(SP), CX
	0x00cb 00203 (main.go:26)	LEAQ	type."".Stringer(SB), DX
	0x00d2 00210 (main.go:26)	MOVQ	DX, (SP)
	0x00d6 00214 (main.go:26)	MOVQ	CX, 8(SP)
	0x00db 00219 (main.go:26)	MOVQ	AX, 16(SP)
	0x00e0 00224 (main.go:26)	PCDATA	$0, $0
	0x00e0 00224 (main.go:26)	CALL	runtime.assertI2I2(SB)
	0x00e5 00229 (main.go:26)	MOVQ	32(SP), AX
	0x00ea 00234 (main.go:26)	MOVQ	24(SP), CX
	0x00ef 00239 (main.go:26)	MOVBLZX	40(SP), DX
	0x00f4 00244 (main.go:26)	MOVQ	CX, "".str+96(SP)
	0x00f9 00249 (main.go:26)	MOVQ	AX, "".str+104(SP)
	0x00fe 00254 (main.go:26)	MOVB	DL, ""..autotmp_8+67(SP)
	0x0102 00258 (main.go:26)	TESTB	DL, DL
	0x0104 00260 (main.go:26)	JNE	267
	0x0106 00262 (main.go:26)	JMP	568
	0x010b 00267 (main.go:29)	JMP	269
	0x010d 00269 (main.go:30)	MOVQ	"".str+96(SP), AX
	0x0112 00274 (main.go:30)	TESTB	AL, (AX)
	0x0114 00276 (main.go:30)	MOVQ	"".str+104(SP), CX
	0x0119 00281 (main.go:30)	MOVQ	24(AX), AX
	0x011d 00285 (main.go:30)	MOVQ	CX, (SP)
	0x0121 00289 (main.go:30)	PCDATA	$0, $0
	0x0121 00289 (main.go:30)	CALL	AX
	0x0123 00291 (main.go:30)	MOVQ	16(SP), AX
	0x0128 00296 (main.go:30)	MOVQ	8(SP), CX
	0x012d 00301 (main.go:30)	MOVQ	CX, ""..autotmp_6+128(SP)
	0x0135 00309 (main.go:30)	MOVQ	AX, ""..autotmp_6+136(SP)
	0x013d 00317 (main.go:30)	XORPS	X0, X0
	0x0140 00320 (main.go:30)	MOVUPS	X0, ""..autotmp_5+144(SP)
	0x0148 00328 (main.go:30)	LEAQ	""..autotmp_5+144(SP), AX
	0x0150 00336 (main.go:30)	MOVQ	AX, ""..autotmp_11+72(SP)
	0x0155 00341 (main.go:30)	LEAQ	type.string(SB), AX
	0x015c 00348 (main.go:30)	MOVQ	AX, (SP)
	0x0160 00352 (main.go:30)	LEAQ	""..autotmp_6+128(SP), AX
	0x0168 00360 (main.go:30)	MOVQ	AX, 8(SP)
	0x016d 00365 (main.go:30)	PCDATA	$0, $2
	0x016d 00365 (main.go:30)	CALL	runtime.convT2Estring(SB)
	0x0172 00370 (main.go:30)	MOVQ	16(SP), AX
	0x0177 00375 (main.go:30)	MOVQ	24(SP), CX
	0x017c 00380 (main.go:30)	MOVQ	AX, ""..autotmp_12+176(SP)
	0x0184 00388 (main.go:30)	MOVQ	CX, ""..autotmp_12+184(SP)
	0x018c 00396 (main.go:30)	MOVQ	""..autotmp_11+72(SP), DX
	0x0191 00401 (main.go:30)	TESTB	AL, (DX)
	0x0193 00403 (main.go:30)	MOVQ	AX, (DX)
	0x0196 00406 (main.go:30)	MOVL	runtime.writeBarrier(SB), AX
	0x019c 00412 (main.go:30)	LEAQ	8(DX), DI
	0x01a0 00416 (main.go:30)	TESTL	AX, AX
	0x01a2 00418 (main.go:30)	JNE	555
	0x01a8 00424 (main.go:30)	JMP	426
	0x01aa 00426 (main.go:30)	MOVQ	CX, 8(DX)
	0x01ae 00430 (main.go:30)	JMP	432
	0x01b0 00432 (main.go:30)	MOVQ	""..autotmp_11+72(SP), AX
	0x01b5 00437 (main.go:30)	TESTB	AL, (AX)
	0x01b7 00439 (main.go:30)	JMP	441
	0x01b9 00441 (main.go:30)	MOVQ	AX, ""..autotmp_10+192(SP)
	0x01c1 00449 (main.go:30)	MOVQ	$1, ""..autotmp_10+200(SP)
	0x01cd 00461 (main.go:30)	MOVQ	$1, ""..autotmp_10+208(SP)
	0x01d9 00473 (main.go:30)	LEAQ	go.string."str(%v) is Stringer\n"(SB), AX
	0x01e0 00480 (main.go:30)	MOVQ	AX, (SP)
	0x01e4 00484 (main.go:30)	MOVQ	$20, 8(SP)
	0x01ed 00493 (main.go:30)	MOVQ	""..autotmp_10+192(SP), AX
	0x01f5 00501 (main.go:30)	MOVQ	""..autotmp_10+200(SP), CX
	0x01fd 00509 (main.go:30)	MOVQ	""..autotmp_10+208(SP), DX
	0x0205 00517 (main.go:30)	MOVQ	AX, 16(SP)
	0x020a 00522 (main.go:30)	MOVQ	CX, 24(SP)
	0x020f 00527 (main.go:30)	MOVQ	DX, 32(SP)
	0x0214 00532 (main.go:30)	PCDATA	$0, $3
	0x0214 00532 (main.go:30)	CALL	fmt.Printf(SB)
	0x0219 00537 (main.go:26)	JMP	539
	...
	0x022e 00558 (main.go:30)	CALL	runtime.gcWriteBarrier(SB)
	0x0233 00563 (main.go:30)	JMP	432
	0x0238 00568 (main.go:26)	JMP	570
	0x023a 00570 (main.go:26)	JMP	539
	0x023c 00572 (main.go:26)	JMP	570
	0x023e 00574 (main.go:26)	NOP
	0x023e 00574 (main.go:21)	PCDATA	$0, $-1
	// 调用runtime.morestack_noctxt执行栈扩容
	0x023e 00574 (main.go:21)	CALL	runtime.morestack_noctxt(SB)
	0x0243 00579 (main.go:21)	JMP	0
...
go.info."".main SDWARFINFO size=82
	...
	0x0020 09 76 61 6c 75 65 00 19 00 00 00 00 03 91 e8 7e  .value.........~
	0x0030 09 76 76 00 17 00 00 00 00 03 91 db 7e 13 00 00  .vv.........~...
	0x0040 00 00 09 73 74 72 00 1d 00 00 00 00 03 91 f8 7e  ...str.........~
	0x0050 00 00                                            ..
	rel 9+8 t=1 "".main+0
