...
func (bl *BeeLogger) SetLogger(adaptername string, config string) error {
	...
	if !ok {
		fmt.Printf("logs: unknown adaptername %q (forgotten Register?)\n", adaptername)
...
func main() {
	...
	// Logger.SetLogger("file", `{"filename":"`+logdir+`run.log"}`)
	Logger.SetLogger("console", "")
	// Logger.EnableFuncCallDepth(true)
	Logger.Debug("config file:", "cfg", "is not existent. maybe you need `mv cfg.example.json cfg.json`")
	// test()
