...
func (c *Context) drawContour(ps []Point, dx, dy fixed.Int26_6) {
	if len(ps) == 0 {
		return
	}
...
func (c *Context) rasterize(glyph Index, fx, fy fixed.Int26_6) (
	...
	c.r.Rasterize(NewAlphaSrcPainter(a))
...
// the range [0, 1).
func (c *Context) glyph(glyph Index, p fixed.Point26_6) (
	fixed.Int26_6, *image.Alpha, image.Point, error) {
